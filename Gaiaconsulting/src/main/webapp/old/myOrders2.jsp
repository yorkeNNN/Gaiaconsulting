				...
				<table id="tbOrderHistory" class="table border ps-table w-100 mb-3">
					<thead>
						<tr>
							...
							<th class="font-weight-bold py-2 border-0 ">Category</th>
							<th class="font-weight-bold py-2 border-0 ">Price</th>
							<th class="font-weight-bold py-2 border-0 ">Quantity</th>
							<th class="font-weight-bold py-2 border-0 ">Sub Total</th>
							<th class="font-weight-bold py-2 border-0 ">Order Date</th>
							<th class="font-weight-bold py-2 border-0 ">Expected Delivery Date</th>
